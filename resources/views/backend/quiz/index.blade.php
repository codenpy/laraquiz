                            ...
                            <thead>
                                ...
                                @foreach($quizes as $quiz)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('quiz.edit', $quiz->id) }}" class="btn" data-original-title="Edit">
                                                <button type="submit" class="btn btn-success">Edit</button>
                                            </a>
                                            <a href="#" class="btn tblDelBtn" data-toggle="modal"
                                               data-target="#deleteModal{{ $quiz->id }}" data-original-title="Delete">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                    </tr> <!-- End single item -->

                                    <!-- Modal Delete -->
                                    <div class="modal fade" id="deleteModal{{ $quiz->id }}" tabindex="-1" role="dialog"
